...
public class Combatant : MonoBehaviour, IDamageable, IBodyChangesHandler
{
    ...
    public bool IsSuperior => _isSuperior;
    ...
    public void Init(SpellUser abilityuser, AutoAttacker autoAttacker, Health health, int damage, int armor,
        int critDamageInPercent, int critChance, int dodgeChance, IReadOnlyList<Spell> attackModifiers, bool isSuperior, DamageType damageType)
    {
        _damage = damage;
        _armor = armor;
    ...
    private void SetStatsFrom(Body body)
    {
        ...
        DamageType = body.Hands.DamageType;
    }
