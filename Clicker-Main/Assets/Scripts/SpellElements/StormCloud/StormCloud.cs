...
public class StormCloud : MonoBehaviour
{
    ...
    public void Init(Combatant owner, RelativeStat damage, DamageType damageType,
    ...
    {
        int damage = _damage.GetRelativeValue(_owner.Target, _owner);
        _owner.Target.TakeDamage(damage, _damageType);
    }
