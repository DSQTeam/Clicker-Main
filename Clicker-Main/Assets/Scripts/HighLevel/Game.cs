...
public class Game : MonoBehaviour
{
    ...
    [SerializeField] private SpellsLayout _spellsLayout;
    ...
    private void Awake()
    {
        ...
        _spellsLayout.Init(_player.Body.Head.Spells, _player.Combatant);
    ...
    private void OnEnable()
    {
        ...
        _player.Traveler.Traveled += OnTravel;
    ...
    private void OnTravel(int locationIndex, int waveIndex)
    {
        ...
        _particleSystemManager.ActivateParticleSystem(locationIndex);
        ...
        _musicPlayer.ChangeClip(location.Music);
    ...
    private void OnPlayerBodyChanged(Body body)
    {
        ...
        _spellsLayout.OnBodyChanged(body);
    }
}