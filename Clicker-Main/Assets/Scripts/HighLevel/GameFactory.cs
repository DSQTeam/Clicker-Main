...
public class GameFactory
{
    ...
    public Combatant CreateEnemy(EnemyStaticData staticData, Vector3 position, bool isSuperior = false)
    {
        ...
        combatant.Init(abilityUser, autoAttacker, health, staticData.Damage, staticData.Armor, staticData.CritDamageInPercent,
            staticData.CritChance,staticData.DodgeChance, staticData.AttackModifiers, isSuperior, staticData.DamageType);
    ...
    {
        var combatant = CreateEnemy(staticData, position, true);
